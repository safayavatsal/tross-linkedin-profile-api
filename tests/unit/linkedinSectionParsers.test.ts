...
// Fixtures shaped per .wayfinder/tickets/T11-staffspy-field-mapping-findings.md's documented
// JSON paths (sourced from reading StaffSpy's actual parsing code) — not live LinkedIn data.
