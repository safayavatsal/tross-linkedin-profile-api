// Voyager "Dash" top-card endpoint URL builder, confirmed live (T12) against a real account.
// This is the only profile data LinkedIn still serves through the classic
