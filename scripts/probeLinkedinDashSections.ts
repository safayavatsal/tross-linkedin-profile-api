// Diagnostic-only, local-run tool for internal ticket T7 — NOT part of the deployed
...
//
// Why raw dump instead of parsed fields: the *endpoints* are sourced from that project's
